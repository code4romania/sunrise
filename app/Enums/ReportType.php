...
enum ReportType: string implements HasLabel
{
    ...
    case CASES_BY_INCOME_AND_EFFECTIVE_ADDRESS = 'cases_by_income_and_effective_address_and_income';
    case CASES_BY_INCOME_EFFECTIVE_ADDRESS_AND_GENDER = 'cases_by_income_and_effective_address_and_income_and_gender';
...
//    case CASES_BY_VIOLENCE_FREQUENCY_GENDER_AND_AGE = 'cases_by_violence_frequency_and_age_and_gender';
//    case CASES_BY_VIOLENCE_TYPE_AND_SERVICES_TYPES = 'cases_by_violence_type_and_services';
//    case CASES_BY_VIOLENCE_TYPE_AND_SERVICES_TYPES_AND_AGE = 'cases_by_violence_type_and_services_and_age';
