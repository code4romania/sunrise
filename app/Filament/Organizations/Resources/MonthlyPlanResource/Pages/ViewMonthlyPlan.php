...
class ViewMonthlyPlan extends ViewRecord
{
    ...
    {
        return InterventionPlanBreadcrumb::make($this->parent)->getViewMonthlyPlan($this->getRecord());
    }
    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            //            EditAction::make()
            //                ->url(InterventionPlanResource::getUrl('edit_monthly_plan', [
        ...
        return $infolist->schema([
            Section::make()
                ...
                ->schema([
                    ...
                    TextEntry::make('caseManager.user.full_name'),
