...
class EditRiskFactors extends EditRecord
{
    ...
    {
        return __('beneficiary.wizard.risk_factors.label');
    }
    ...
    protected function getRedirectUrl(): string
    {
        ...
        return InitialEvaluationResource::getUrl('view', [
            'beneficiary' => $record,
            'record' => $record->evaluateDetails,
        ]).'?tab='.\Illuminate\Support\Str::slug(__('beneficiary.wizard.risk_factors.label'));
    }
    ...
    public function form(Schema $schema): Schema
    {
        return $schema
            ->columns(1)
            ->components(InitialEvaluationSchema::getRiskFactorsFormComponents());
    }
}
