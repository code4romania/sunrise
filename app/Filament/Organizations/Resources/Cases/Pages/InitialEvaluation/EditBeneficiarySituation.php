...
class EditBeneficiarySituation extends EditRecord
{
    ...
    {
        return __('beneficiary.wizard.beneficiary_situation.label');
    }
    ...
    public function getBreadcrumbs(): array
    {
        ...
        return [
            ...
            '' => __('beneficiary.wizard.beneficiary_situation.label'),
        ];
    }
    ...
    protected function getRedirectUrl(): string
    {
        ...
        return InitialEvaluationResource::getUrl('view', [
            'beneficiary' => $record,
            'record' => $record->evaluateDetails,
        ]).'?tab='.\Illuminate\Support\Str::slug(__('beneficiary.wizard.beneficiary_situation.label'));
    }
    ...
    public function form(Schema $schema): Schema
    {
        return $schema
            ->columns(1)
            ->components(InitialEvaluationSchema::getBeneficiarySituationFormComponents());
    }
}
