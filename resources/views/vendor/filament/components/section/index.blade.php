...
<section
    ...
    {{
        $attributes->class([
            ...
            'rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10' => ! $compact && ! $aside
        ])
    }}
>
    @if ($hasHeader)
    ...
    <div
        ...
        @class([
            ...
            'border-t border-gray-200 dark:border-white/10' => $hasHeader && (! $aside) && (! $compact),
