...
@php
    ...
    $inactiveItemClasses = 'bg-white hover:bg-gray-50 focus-visible:bg-gray-50 dark:hover:bg-white/5 dark:focus-visible:bg-white/5';

    // @deprecated `fi-tabs-item-active` has been replaced by `fi-active`.
    $activeItemClasses = 'fi-active fi-tabs-item-active bg-primary-100 dark:bg-primary-800';
    ...
    $activeLabelClasses = 'font-bold text-gray-800 dark:text-gray-200';
...
<{{ $tag }}
    ...
    {{
        $attributes
            ...
            ->class([
                'fi-tabs-item group flex items-center gap-x-2 rounded-lg px-4 py-2 text-sm font-medium outline-none transition duration-75',
