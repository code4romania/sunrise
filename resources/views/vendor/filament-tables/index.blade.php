    ...
    <x-filament-tables::container>
        ...
        >
            ...
            @elseif (($heading || $description || $headerActions) && ! $isReordering)
                @php
                    if ($reorderRecordsTriggerAction){
                        array_unshift($headerActions, $reorderRecordsTriggerAction);
                    }
                @endphp
            ...
            @elseif($isReordering && $reorderRecordsTriggerAction)
                ...
                <x-filament-tables::header
                    :actions="[$reorderRecordsTriggerAction]"
                    :actions-position="$headerActionsPosition"
                    :description="$description"
                    :heading="$heading"
                />
