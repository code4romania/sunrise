...
@props([
    ...
    'sortDirection',
    'wrap' => false,
    'samePaddingForFirstAndLastCell' => false,
])
...
<th
    ...
    @endif
    {{ $attributes->merge(match ($samePaddingForFirstAndLastCell){
            true => ['ps-6 pe-6'],
            false => ['sm:first-of-type:ps-6 sm:last-of-type:pe-6']
        }, escape: false)->class(['fi-ta-header-cell px-3 py-3.5']) }}
>
