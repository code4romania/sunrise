...
return [
    ...
    'headings' => [
        ...
        'inactivate_benefit_type_modal' => 'Inactivează tipul de beneficiu',
        'inactivate_result_modal' => 'Inactivează rezultatul pentru toate nomenclatoarele',
        'inactivate_intervention_modal' => 'Inactivează intervenția',
    ...
    'helper_texts' => [
        ...
        'inactivate_benefit_modal' => 'Prin inactivarea beneficiului, acesta nu va mai fi disponibil pentru fi adăugat în nomenclatoarele de beneficii ale organizațiilor Sunrise. Pentru organizațiile care au folosit deja acest beneficiu, acesta va fi retras din nomenclatoare, fără să se șteargă din istoricul Dosarului servicii VD pentru care a fost folosit.',
        'inactivate_benefit_type_modal' => 'Prin inactivarea tipului de beneficiu, acesta nu va mai fi disponibil pentru fi adăugat în nomenclatoarele organizațiilor Sunrise. Pentru organizațiile care au folosit deja acest tip, acesta va fi retras din nomenclatoare, fără să se șteargă din istoricul Dosarului servicii VD pentru care a fost folosit.',
        'inactivate_result_modal' => 'Prin inactivarea rezultatului, acesta nu va mai fi disponibil pentru fi adăugat în nomenclatoarele de rezultate ale organizațiilor Sunrise. Pentru organizațiile care au folosit deja acest rezultat, acesta va fi retras din nomenclatoare, fără să se șteargă din istoricul Dosarului servicii VD pentru care a fost folosit.',
        'inactivate_intervention_modal' => 'Prin inactivarea intervenției, aceasta nu va mai fi disponibilă pentru fi adăugată în nomenclatorul organizațiilor Sunrise. Pentru organizațiile care au folosit deja această intervenție, aceasta va fi retrasă din nomenclatoare, fără să se șteargă din istoricul cazurilor în care a fost folosită.',
    ...
    'actions' => [
        'change_status' => [
            ...
            'inactivate_benefit_modal' => 'Inactivează beneficiu',
            'inactivate_benefit_type_modal' => 'Inactivează tipul de beneficiu',
