...
return [
    ...
    'section' => [
        ...
        'initial_evaluation' => [
            ...
            'heading' => [
                ...
                'evaluation_details' => 'Detalii evaluare',
            ...
            'labels' => [
                ...
                'identity_last_name' => 'Nume',
                'identity_first_name' => 'Prenume',
                'identity_prior_name' => 'Nume anterior',
                'identity_civil_status' => 'Starea civilă',
                'identity_cnp' => 'CNP',
                'identity_gender' => 'Genul',
                'identity_birthdate' => 'Data nașterii',
                'identity_birthplace' => 'Locul nașterii',
                'identity_citizenship' => 'Cetățenie',
                'identity_id_type' => 'Act de identitate (tip)',
                'identity_id_serial' => 'Serie act de identitate',
                'identity_id_number' => 'Număr act de identitate',
                'identity_legal_address' => 'Adresa domiciliu legal',
                'identity_effective_address' => 'Adresa reședință',
                'identity_primary_phone' => 'Număr telefon primar',
                'identity_backup_phone' => 'Număr telefon rezervă',
                'identity_contact_notes' => 'Notițe legate de contactare beneficiar',
                'identity_studies' => 'Studii absolvite',
                'identity_occupation' => 'Ocupația',
                'identity_workplace' => 'Locul de muncă',
                'no_children' => 'Nu există copii înregistrați',
        ...
        'detailed_evaluation' => [
            'labels' => [
                ...
                'relationship' => 'Relația cu copilul/ familia',
                'contact_date' => 'Data contactării',
                'meetings' => 'Întrevederi (sau convorbiri telefonice) pentru colectarea datelor',
                'specialist' => 'Specialist',
                'date' => 'Data',
                'location' => 'Locația',
                ...
                'recommendations_for_intervention_plan' => 'Listați toate eventualele recomandări pentru Dosar servicii VD',
            ...
            'heading' => [
                ...
                'risk' => 'Riscuri',
                'partner' => 'Soțul/ partenerul/ tipul relației',
                'recommendations_for_intervention_plan' => 'Recomandări pentru Dosar servicii VD',
                'recommendation_services' => 'Servicii recomandate',
            ],
        ],
        ...
        'history' => [
            ...
            'labels' => [
                ...
                'view_action' => 'Detalii',
                'beneficiary' => 'Beneficiar',
                'pdf_identity_exported' => 'Export PDF: identitate beneficiar',
                'pdf_case_info_exported' => 'Export PDF: informații caz',
                'pdf_initial_evaluation_exported' => 'Export PDF: evaluare inițială',
                ...
                'pdf_social_counseling_sheet_exported' => 'Export PDF: fișă consiliere asistență socială',
                ...
                'interventionPlan' => 'Dosar servicii VD',
                'interventionService' => 'Dosar servicii VD, Servicii',
                'beneficiaryIntervention' => 'Dosar servicii VD, Servicii, Intervenții',
                'children' => 'Copil',
                ...
                'benefitService' => 'Dosar servicii VD, Beneficii',
                'interventionPlanResult' => 'Dosar servicii VD, Rezultate',
        ...
        'close_file' => [
            ...
            'pdf' => [
                'document_title' => 'FIȘĂ DE ÎNCHIDERE A CAZULUI',
                'name_label' => 'Nume și prenume:',
                'cnp_label' => 'CNP:',
                'admittance_date_cpru' => 'Data admiterii în serviciu:',
                'exit_date_cpru' => 'Data ieșirii din serviciu:',
                'admission_reason_heading' => 'Motivul accesării serviciilor',
                'close_method_heading' => 'Modalitatea de închidere a cazului',
                'close_situation_heading' => 'Situația cazului la închidere',
                'closure_sheet_date' => 'Data:',
                'motiv_label' => 'Motivul:',
                'other_situation_label' => 'Altă situație:',
                'prepared_by' => 'Întocmit,',
                'case_manager_role' => 'Manager de caz',
            ],
            'actions' => [
    ...
    'placeholder' => [
        ...
        'partner_last_name' => 'Introdu numele de familie',
        'partner_first_name' => 'Introdu numele mic',
        'partner_age' => 'Vârsta în ani împliniți',
        ...
        'violence_means_specify' => 'Specificați',
    ...
    'helper_text' => [
        ...
        'detailed_evaluation_2' => 'Pentru informarea Dosarului servicii VD',
