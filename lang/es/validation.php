...
return [
    ...
    */
    ...
    'cif' => 'El campo :attribute no tiene un formato de CIF válido.',
    'cnp' => 'El campo :attribute no tiene un formato de documento de identidad válido.',
    'custom' => [
        'attribute-name' => [
            'rule-name' => 'El mensaje de error personalizado para :attribute.',
        ],
    ],
];
